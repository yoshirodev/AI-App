...
function ChangeYandereExpression(){
    let mascotElement = document.querySelector(".Mascot");
    let images = ["img/Mascot/y12.png", "img/Mascot/y22.png", "img/Mascot/y32.png", "img/Mascot/y42.png", "img/Mascot/y52.png"];
    let randomIndex = Math.floor(Math.random() * images.length);
    let randomImage = images[randomIndex];
    mascotElement.style.backgroundImage = `url(${randomImage})`;
    mascotElement.style.backgroundSize = "720px 950px";
}